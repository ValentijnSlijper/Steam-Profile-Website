...
(function () {
        ...
        $(document).ready(function () {
            ...
            for (var i in links)
            {
                ...
                if (i != links.length - 1)
                    $('#marquee').append(' <img class="emoticon" src="assets/others/arrow-grey.png"> ');
        ...
        (function ()
        {
            ...
            $.getJSON('https://api.ipdata.co/?api-key=ad7a1e62b6f8c99a92da5c98c776ab1353b02f0ba1f8c8306652b903', function (data) {

                writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #F00;'>[unknown]</span>..."], 30, function () {
        ...
        animIndex = 0;
            ...
            var tKillNames = ["Fresh"];
            var ctKillNames = ["Supremacy", "Project-Infinity", "Gamesense", "Aimware", "Interwebz", "Zeus", "Singularity", "420Cheats", "Styles", "Fatality"];
            var weapons = ["ssg08", "ak47", "deagle", "scar-20", "m4a4"];
